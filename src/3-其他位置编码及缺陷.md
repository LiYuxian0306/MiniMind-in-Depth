...
$$
a_{m,n} = \frac{\exp\left(\frac{q_m^T k_n}{\sqrt{d}}\right)}{\sum_{j=1}^N \exp\left(\frac{q_m^T k_j}{\sqrt{d}}\right)} = \frac{\exp\left(\frac{q^T k}{\sqrt{d}}\right)}{\sum_{j=1}^N \exp\left(\frac{q^T k}{\sqrt{d}}\right)}
$$
